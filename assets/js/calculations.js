...
function load_sequence() {
    ...
    $('#theFormAy').show();
    var filename = $('#dropDown1').children("option:selected").val();
     //var str = "<button id='loadButton' name='load' onclick='load_xml(); open_comments();'>Load File</button><select id='dropDown' name='dropDown'>";
    //$('#filler').html("<button id='loadButton' name='load' onclick='load_xml();'>Load File</button>");
	//$('#loadButton').html('Load File');	
	$('#test').html("<button id='loadButton' name='load' onclick='load_xml()'>Load File</button>");
	$('#whatIfButton').hide();
	//$('#submitButton').hide();  
     $('#dropDown1').show();
    //load_choosefile(/*str*/); 
...
function load_xml() {
	console.log(DIR + "ct310/m2/XMLSaves/" + $("#dropDown1").children("option:selected").text())
    ...
    xhttp.open("GET", DIR + "ct310/m2/XMLSaves/" + $("#dropDown1").children("option:selected").text(), true);
    xhttp.send();
}
