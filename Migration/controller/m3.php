...
// 	public function post_run_migrations($status) {
//         if ($status == 0) {
//             var_dump('runup');
//         }
//         else {
...
//         echo 'ahaaaaaaaaaaaaaaaaaaaaaaaaaaah';
//         var_dump(Input::post('migrst'));
//         var_dump(Input::post('migrid'));
...
public function action_get_migrations() {
